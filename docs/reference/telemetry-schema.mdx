...
| `install.method_selected` | `{method, region}` | User picked CloudFormation deploy method (`cfn`) + region. |
| `install.deploy_started` | `{method, region, pack}` | CloudFormation stack creation kicked off. |
